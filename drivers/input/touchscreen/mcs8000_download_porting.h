...
#define MCSDL_VDD_SET_HIGH()             			data->power(true);
#define MCSDL_VDD_SET_LOW()              			data->power(false);
#else
...
#define MCSDL_CE_SET_HIGH()   	          		    data->power(true);
#define MCSDL_CE_SET_LOW()      	        		data->power(false);
...
/* for samsung */
#define melfas_i2c_gpio_scl()		                gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SCL,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),1);
#define melfas_i2c_gpio_sda()		                gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SDA,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),1); 
/* for samsung */
...
#define MCSDL_RESETB_SET_OUTPUT(n)     		        gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_INT, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
#define MCSDL_RESETB_SET_INPUT()            		gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_INT, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
#else
...
#define MCSDL_GPIO_SCL_SET_OUTPUT(n)				gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SCL,  0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),1);
#define MCSDL_GPIO_SCL_SET_INPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SCL,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),1);

#define MCSDL_GPIO_SDA_SET_OUTPUT(n)				gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SDA,  0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),1);
#define MCSDL_GPIO_SDA_SET_INPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SDA,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),1);
