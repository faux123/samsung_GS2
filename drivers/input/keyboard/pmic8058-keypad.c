...
extern void TSP_force_released(void);
#endif
#endif 
/* ---------------------------------------------------------------------*/
struct pmic8058_kp {
...
static DEVICE_ATTR(key_pressed, 0664, pmic8058_kp_pressed_show, NULL);

static struct attribute *pmic8058_keys_attrs[] = {
	&dev_attr_disable_kp.attr,
	&dev_attr_key_pressed.attr,
	NULL,
};

static struct attribute_group pmic8058_keys_attr_group = {
	.attrs = pmic8058_keys_attrs,
};
