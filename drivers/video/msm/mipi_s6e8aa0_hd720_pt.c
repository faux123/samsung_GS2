...
#endif
static int __init mipi_video_s6e8aa0_hd720_pt_init(void)
{
	int ret;
    printk("Mipi_Lcd : mipi_video_s6e8aa0_hd720_pt_init \n");
#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_s6e8aa0_hd720"))
		return 0;
#endif
	...
	pinfo.lcdc.h_front_porch = 175;                              // HFP : ~1.03us
	pinfo.lcdc.h_pulse_width = 2;	   
#elif (MIPI_MBPS==480)
	pinfo.lcdc.h_back_porch = 153; 
	pinfo.lcdc.h_front_porch = 153;                              // HFP : ~1.03us
	pinfo.lcdc.h_pulse_width = 2;	   
#elif (MIPI_MBPS==490)
	pinfo.lcdc.h_back_porch = 164; 
	pinfo.lcdc.h_front_porch = 164;                              // HFP : ~1.03us
	pinfo.lcdc.h_pulse_width = 2;	   
#elif (MIPI_MBPS==510)
	pinfo.lcdc.h_back_porch = 185; 
	pinfo.lcdc.h_front_porch = 185;                              // HFP : ~1.03us
	pinfo.lcdc.h_pulse_width = 2;	   
#else
#error unknown MIPI_MBPS
#endif
...
module_init(mipi_video_s6e8aa0_hd720_pt_init);
