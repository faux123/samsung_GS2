...
static int showall_debug_get(void *data, u64 *val)
{
	return showall_enabled();
}

DEFINE_SIMPLE_ATTRIBUTE(showall_fops, showall_debug_get, NULL,
		"%llu\n");
...
static int reg_debug_init(void)
{
	...
	(void) debugfs_create_file("showall", S_IRUGO,
		   debugfs_base, NULL, &showall_fops);
